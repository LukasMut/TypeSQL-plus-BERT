...
if __name__ == '__main__':
    ...
    #print("Loading bert context embeddings")
    #id2tok, word_emb_bert = load_bert_dicts("./idx2tok.json", "./id2embed.json")
    #print("Bert context embeddings have been loaded into memory")
